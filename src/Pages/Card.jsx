  ...
  const handleClick = async () => {
    ...
    if (localStorage.getItem("user")) {
      ...
      let response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/investor/me`,
        {
          headers: {
      ...
      if (enteredCoins > props.askprice) {
        ...
        response = await axios.post(
          `${process.env.REACT_APP_BASE_URL}/investor/invest`,
          body,
          {
            headers: {
    ...
    <div className="card">
      ...
      <div className="card-body">
        <div className="card-details">
          ...
          {props.investorsNostatus ? (
            <p className="card-text">Investors : {props.investorNo}</p>
          ) : (
            <></>
          )}
          {props.buttonstatus ? (
        ...
        <div className="chart-container">
          ...
          {props.ownernamestatus ? (
            <p className="card-text"> ~ {props.ownername}</p>
          ) : (
            <></>
          )}
        </div>
