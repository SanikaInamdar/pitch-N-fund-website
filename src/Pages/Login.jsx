...
function Login() {
  ...
  function Invalid() {
    if (!isValid) {
      return <p id="invalid-user">Incorrect Username or Password.</p>;
    }
  }
  ...
  const submitData = async (e) => {
    ...
    const result = await axios.post(
      `${process.env.REACT_APP_BASE_URL}/${credentials.usertype}/login`,
      body
    );
    ...
    <Layout>
      <div id="login_container" className="container">
        <form id="login_form">
          ...
          <button
            type="submit"
            className="btn btn-primary btn-block login_buttons"
            onClick={submitData}
          >
            Login
          </button>
