...
function SignUp() {
  ...
  function Invalid() {
    if (!isValid) {
      return <p id="invalid-user">Email is Invalid or Already taken.</p>;
    }
  }
  ...
  const submitData = async (e) => {
    ...
    const result = await axios.post(
      `${process.env.REACT_APP_BASE_URL}/${credentials.usertype}`,
      body
    );
    ...
    <Layout>
      <div id="signup_container" className="container">
        <form id="signup_form">
          ...
          <Invalid />
          <button
            className="btn btn-primary btn-block signup_buttons"
            onClick={submitData}
          >
            Sign Up
          </button>
